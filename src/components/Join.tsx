...
const Join: React.FC = () => {
  return (
    <div className="join w-full p-2 md:p-6 lg:p-6 max-w-screen-xl flex flex-col md:flex-row items-center justify-center mx-auto">
      <div className="grid gap-4 grid-cols-2 md:grid-cols-2 lg:grid-cols-2 justify-center items-center mx-auto w-[fit-content]">
        <div className="md:w-6/10 w-[fit-content] mx-auto w-full">
          ...
          <div className="h-1 bg-gradient-to-r from-pink-600 via-red-500 to-yellow-400 rounded mt-10 w-11/12"></div>          
        </div>
