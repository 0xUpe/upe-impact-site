...
const BadgeItem: React.FC<BadgeItemProps> = ({ title, image }) => {
  return (
    <div className="flex flex-col border border-white-800 p-4 rounded-lg hover:bg-zinc-900 transition-colors hover:border-zinc-700 items-center justify-center">
